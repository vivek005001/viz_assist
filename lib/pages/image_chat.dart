...
class _ChatPageState extends State<ChatPage> {
  ...
  ChatUser geminiUser = ChatUser(id: '1', firstName: 'Gemini', profileImage: 'assets/gemini-icon.svg');
  @override
  ...
  Widget _buildUI() {
    return DashChat(
        inputOptions: InputOptions(trailing: [IconButton(onPressed: _sendMediaMessage, icon: Icon(Icons.image),)]),
